# 02_catalog-test.sh
# creates a test catalog for the metastore
...
export DEFAULT_CATALOG_NAME='catalog-test'
export PROFILE="test"

# assign the workspace to the metastore

export WORKSPACE_ID=$(az databricks workspace list --query "[?contains(name, 'databricks-test')].workspaceId" -o tsv)
...
echo "Finished creating the test catalog."